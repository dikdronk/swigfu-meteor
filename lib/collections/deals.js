...
Meteor.methods({
  ...
  upvote: function(dealId) {
    ...
    if (!deal)
      throw new Meteor.Error('invalid', 'Deal not found!');

    if (_.include(deal.upvoters, this.userId))
      throw new Meteor.Error('invalid', 'Already upvoted this deal!');

    Deals.update(deal._id, {
